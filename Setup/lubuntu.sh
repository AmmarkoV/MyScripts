...
SYSTEM="smartmontools iotop iftop iperf ifmetric htop gtkperf traceroute powertop x11vnc net-tools grub-customizer libvdpau-va-gl1 curl wget vdpauinfo neofetch" #macchanger-gtk  sysv-rc-conf 
